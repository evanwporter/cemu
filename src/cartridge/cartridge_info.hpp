...
constexpr uint MAX_ROM_SIZE = 1 * 1024 * 1024; // 1 MB
constexpr uint MAX_RAM_SIZE = 32 * 1024; // 32 KB
...
extern CartridgeType get_cartridge_type(const std::array<u8, MAX_ROM_SIZE>& rom);
